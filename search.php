...
<ul class="nav nav-tabs" id="myTab">
  ...
  <li><a href="#properties">Search By Properties</a></li>
</ul>
...
<div class="tab-content">
  ...
  <div class="span6">
	   ...
	   <label>
<select id="search" name="search" type="text">
...
<script type="text/javascript" src="http://www.google.com/jsapi"></script>
<script type="text/javascript">
	document.getElementById("clickprop").addEventListener("click", drawVisualization);
google.load('visualization', '1', {packages: ['table']});
</script>
<script type="text/javascript">
var visualization;
...
query2.setQuery('SELECT *  <?php echo $search2; ?> <?php echo $search3; ?> <?php echo $search4; ?> ');
